...
> 🚧 **Beta Software — No Independent Security Audit.** seQRets v1.10.1 has not undergone a formal third-party security audit. Do not use seQRets as your only backup for high-value secrets. Always maintain independent backups (hardware wallet, paper backup in a fireproof safe, etc.) until a formal audit has been completed.

...
import { ArrowLeft, ShieldCheck, EyeOff, Database, Bot, Globe, Cookie, Server } from "lucide-react";
                                ...
                                <table className="w-full text-sm">
                                    ...
                                    <tbody>
                                        <tr className="bg-muted/30">
                                            <td className="p-3 font-medium text-foreground">GitHub Pages</td>
                                            <td className="p-3">Hosting</td>
                                            <td className="p-3">Standard server logs (IP, user agent)</td>
                                        </tr>
                                        <tr>

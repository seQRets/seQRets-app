                    ...
                    <Card>
                        ...
                        <CardContent className="text-sm text-muted-foreground space-y-2">
                            ...
                            <p>
                                ...
                                <a href="mailto:licensing@seqrets.app" className="underline text-foreground hover:text-primary">licensing@seqrets.app</a>.
                            </p>
                        </CardContent>
                    </Card>
                ...
                <Card className="mb-8 border-primary/20">
                    <CardContent className="pt-6 text-sm text-muted-foreground space-y-2">
                        ...
                        <p>
                            ...
                            <a href="mailto:hello@seqrets.app" className="underline text-foreground hover:text-primary">
                                hello@seqrets.app
                            </a>.
                        </p>
                    </CardContent>

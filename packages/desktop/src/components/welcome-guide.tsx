    ...
    <ModalShell open={open} stepLabel="Step 2 of 2">
      ...
      <div className="grid grid-cols-2 gap-x-6 gap-y-2 mb-6 text-[13px]">
        ...
        <div className="flex items-center gap-2">
          <span className="text-amber-400 font-bold">②</span>
          <span className="text-[hsl(37,10%,75%)]">
            <strong className="text-[hsl(37,10%,85%)]">Tabs</strong> — Secure, Inherit, Restore
          </span>
        </div>
        <div className="flex items-center gap-2">
          <span className="text-amber-400 font-bold">③</span>
          <span className="text-[hsl(37,10%,75%)]">
            <strong className="text-[hsl(37,10%,85%)]">Secret</strong> — Your seed phrase
          </span>
        </div>
        <div className="flex items-center gap-2">
          <span className="text-amber-400 font-bold">④</span>
          <span className="text-[hsl(37,10%,75%)]">
            <strong className="text-[hsl(37,10%,85%)]">Settings</strong> — Password & splits
          </span>
        </div>
        <div className="flex items-center gap-2">
          <span className="text-amber-400 font-bold">⑤</span>
          <span className="text-[hsl(37,10%,75%)]">
            <strong className="text-[hsl(37,10%,85%)]">Encrypt</strong> — Generate Qards
          </span>
        </div>
        <div className="flex items-center gap-2">
          <span className="text-amber-400 font-bold">⑥</span>
